...
- [ ] **Step 2: Implement `AccountSwitcher`**
...
- [ ] **Step 3: Integrate account loading and switching in `App`**
...
- [ ] **Step 1: Implement layout and accessible states**
