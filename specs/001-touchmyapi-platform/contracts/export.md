...
Admin audit additionally records staff identity, capability grant, ticket reference, reason, approval count, TTL, and outcome. Billing records remain read-only to admin; entitlement and credit changes still require verified Stripe webhooks.
